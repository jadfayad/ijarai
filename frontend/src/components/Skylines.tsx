...
export function NewYorkSkyline({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 100" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export function SingaporeSkyline({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 100" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export function HongKongSkyline({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 100" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export function TokyoSkyline({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 100" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export function SydneySkyline({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 100" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export function ParisSkyline({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 100" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export function SanFranciscoSkyline({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 200 100" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      {/* Downtown buildings */}
      <path d="M5,100 L5,62 L9,62 L9,100 Z" />
      <path d="M13,100 L13,54 L16,54 L16,47 L19,47 L19,54 L22,54 L22,100 Z" />
      {/* Transamerica Pyramid */}
      <path d="M27,100 L27,48 L29,48 L29,30 L31.5,8 L34,30 L34,48 L36,48 L36,100 Z" />
      {/* Salesforce Tower */}
      <path d="M41,100 L41,36 L44,36 Q46.5,26 49,36 L49,100 Z" />
      {/* More downtown */}
      <path d="M53,100 L53,50 L56,50 L56,44 L59,44 L59,50 L62,50 L62,100 Z" />
      {/* Golden Gate Bridge — left tower */}
      <rect x="76" y="28" width="3" height="72" />
      <rect x="74" y="28" width="7" height="2.5" />
      <rect x="74" y="37" width="7" height="1.5" />
      {/* Right tower */}
      <rect x="152" y="28" width="3" height="72" />
      <rect x="150" y="28" width="7" height="2.5" />
      <rect x="150" y="37" width="7" height="1.5" />
      {/* Main cable */}
      <path d="M74,30 Q114,62 156,30" fill="none" stroke="currentColor" strokeWidth="2" />
      {/* Suspension cables */}
      <line x1="84" y1="37" x2="84" y2="58" stroke="currentColor" strokeWidth="0.7" />
      <line x1="94" y1="42" x2="94" y2="58" stroke="currentColor" strokeWidth="0.7" />
      <line x1="104" y1="45" x2="104" y2="58" stroke="currentColor" strokeWidth="0.7" />
      <line x1="114" y1="46" x2="114" y2="58" stroke="currentColor" strokeWidth="0.7" />
      <line x1="124" y1="45" x2="124" y2="58" stroke="currentColor" strokeWidth="0.7" />
      <line x1="134" y1="42" x2="134" y2="58" stroke="currentColor" strokeWidth="0.7" />
      <line x1="144" y1="37" x2="144" y2="58" stroke="currentColor" strokeWidth="0.7" />
      {/* Road deck */}
      <rect x="72" y="58" width="90" height="3" rx="1" />
      {/* Right-side buildings */}
      <path d="M167,100 L167,52 L171,52 L171,100 Z" />
      <path d="M176,100 L176,48 L179,48 L179,42 L182,42 L182,48 L185,48 L185,100 Z" />
      <path d="M190,100 L190,55 L194,55 L194,100 Z" />
      <rect x="0" y="98" width="200" height="2" />
    </svg>
  );
}
